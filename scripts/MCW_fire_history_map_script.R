...
FirehistMap <- leaflet() %>%
  ...
  addLabelOnlyMarkers(data = h_fires, lng = -123.5670, lat = 48.84805, label = "1934", labelOptions = labelOptions(noHide = TRUE, direction = 'middle', textOnly = TRUE)) %>%
  addLabelOnlyMarkers(data = h_fires, lng = -123.5519, lat = 48.85045, label = "1935", labelOptions = labelOptions(noHide = TRUE, direction = 'middle', textOnly = TRUE)) %>%
  addLabelOnlyMarkers(data = h_fires, lng = -123.5230, lat = 48.82397 , label = "1935", labelOptions = labelOptions(noHide = TRUE, direction = 'middle', textOnly = TRUE)) %>%
  addLabelOnlyMarkers(data = h_fires, lng = -123.5207, lat = 48.81398, label = "1942", labelOptions = labelOptions(noHide = TRUE, direction = 'middle', textOnly = TRUE)) %>%
