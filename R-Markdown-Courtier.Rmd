...
# Baseline Observation Study Plots
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
source("scripts/MCW_Vegetation_plots_map_script.R")
VegMap
```

### Other surveys
1. Coarse woody material, fine woody material, shrub cover, and DBH
2. Prism plot
3. Ground moisture measurements
